...
OUT_PATH = "data/model_eval_walkforward_v34a.parquet"
...
def compute_blowout_mode(
    ...
    # Primary gates (unchanged from v33)
    ...
    # v34.a: second-meeting confidence boost
...
# -------------------------------------------------
# Score engine (IDENTICAL to v33-final)
# -------------------------------------------------
...
def main():
    ...
    # Track matchup history walk-forward
    matchup_history = set()
    ...
    for _, g in games.iterrows():
        ...
        has_played_before = matchup_key in matchup_history
        ...
        rows.append(
            {
                ...
                "SecondMeeting": has_played_before,
                "BlowoutMode": blowout,
            }
        )
