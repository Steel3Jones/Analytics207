...
class ScoreConfig:
    def __init__(
        ...
        margin_divisor_normal: float = 12.0,
...
def main() -> None:
    ...
    # Win-prob calibration in POINTS space (pm = PredMargin, home - away)
    # Lower => more extreme probabilities; start at 8.0 based on your quick test.
    PROB_POINT_SCALE = 8.0
    ...
    for _, g in games.iterrows():
        ...
        # FIX: derive win prob from PredMargin (pm) so prob & spread agree
        win_prob = sigmoid(float(pm) / float(PROB_POINT_SCALE))
