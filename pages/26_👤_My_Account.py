...
if user:
    ...
    with col_status:
        ...
        if sub_status == "active":
            ...
            st.warning("⚠️ Past Due — Please update payment")
...
<table class="plan-table">
    <thead>
        <tr>
            <th>Feature</th>
            <th>{hdr("Free", "free")}</th>
            <th>{hdr("Monthly · $4.99/mo", "monthly")}</th>
...
if sub_status != "active":
    ...
    with col1:
        ...
        <div style="background:rgba(59,130,246,0.08); border:1px solid rgba(59,130,246,0.3);
            ...
            <div style="font-size:24px; font-weight:900; color:#60a5fa;">$4.99</div>
            <div style="font-size:12px; color:#94a3b8; margin-bottom:12px;">per month · cancel anytime</div>
            <div style="font-size:13px; color:#cbd5e1;">Full access to all analytics, predictions, and tools. Billed monthly.</div>
        </div>
    ...
    with col2:
        ...
        <div style="background:rgba(245,158,11,0.08); border:1px solid rgba(245,158,11,0.3);
            ...
            <div style="font-size:13px; color:#cbd5e1;">Lock in the entire season. Best value for dedicated fans.</div>
        </div>
        """, unsafe_allow_html=True)
        if user:
