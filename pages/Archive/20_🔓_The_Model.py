...
metrics_core = [
    ...
    ("TRUE INDEX","TI",     True,  1, "True Index (TI scale)."),
...
<style>
  ...
  .card {{
    background:radial-gradient(circle at top left,#101827,#020617);
    border:1px solid rgba(96,165,250,0.45); border-radius:22px;
  ...
  .hero-left {{ background:rgba(15,23,42,0.80); border-radius:18px;
                border:1px solid rgba(148,163,184,0.35); padding:18px 20px 16px; }}
